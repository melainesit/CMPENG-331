...
HD_PWD='C:/Xilinx/CMPEN_331/CMPEN331_Lab4/CMPEN331_Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IfId.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IfId.tcl -notrace
